...
{context} 
根据上述已知信息，专业的来回答用户的问题。如果无法从中得到答案，请说 “根据已知信息无法回答该问题”，不允许在答案中添加编造成分，答案请使用中文。 问题是：{query}"""

SMART_QA_PROMPT_TEMPLATE = """已知信息：
{context} 
参考上述已知信息来回答用户的问题，如果无法从中得到答案，请忽略已知信息。 问题是：{query}"""
